...
DATA_PATH = "/Users/mcmenamin/Dropbox/Democratic Freedom DataDive/LA Mayor's Office - Ellis Act/modified datasets"

DATA_PATH = '/Users/mcmenamin/GitHub/la_mayors_office/data'
...
df_housing_prediction = (
    ...
    join(
        df_warning.set_index('Property ID')[['num_demo_permits', 'Total Actions Before Ellis', 'Prediction']],
        how='inner'
    )
)
